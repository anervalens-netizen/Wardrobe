...
export default function AssistantPage() {
  ...
  async function sendMessage(content: string) {
    ...
    try {
      ...
      if (!res.ok) throw new Error("Eroare la comunicarea cu asistentul");

      const reader = res.body?.getReader();
      if (!reader) throw new Error("Nu pot citi răspunsul");
      ...
      setMessages([
        ...
        {
          role: "assistant",
          content: "Scuze, am întâmpinat o eroare. Încearcă din nou.",
        },
      ]);
    } finally {
      setLoading(false);
